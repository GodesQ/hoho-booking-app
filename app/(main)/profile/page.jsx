                ...
                <div className="flex justify-between gap-5">
                    <div className="profile-sidebar">
                        ...
                        <div className="profile-sidebar-tabs">
                            <div className={`tab ${activeTabIndex == 1 ? "active" : ""}`} onClick={() => setActiveTabIndex(1)}>
                                Profile
                            </div>
                            <div className={`tab ${activeTabIndex == 2 ? "active" : ""}`} onClick={() => setActiveTabIndex(2)}>
                                Tour Reservations
                            </div>
                    ...
                    <div className="profile-content-container">
                        <div className="tab-panel h-full">
                            <div className={`tab-content h-full ${activeTabIndex == 1 ? "show" : ""}`}>
                                ...
                                <div className="columns-1 sm:columns-2 space-y-3 mb-2">
                                    <Input label="Firstname" value={profile.firstname} onChange={(e) => setProfile({ ...profile, firstname: e.target.value })} />
                                    <Input label="Lastname" value={profile.lastname} onChange={(e) => setProfile({ ...profile, lastname: e.target.value })} />
                                </div>
                                <div className="columns-1 sm:columns-1 space-y-3 mb-2">
                                    <div className="phone-number-input">
                                        <PhoneInput
                                            ...
                                            className="h-full"
                                            value={`+${profile.contact_no.countryCode}${profile.contact_no.number}`}
                                            onChange={handleContactNumber}
                                        />
                                    </div>
                                </div>
                                <Button className="bg-primary text-foreground mt-3" onClick={handleSubmitProfile}>
                                    Save Changes
                                </Button>
                            </div>
                                                ...
                                                <CardBody>
                                                    <div className="flex justify-between items-start gap-2">
                                                        ...
                                                        <div className="flex-1 text-black">
                                                            ...
                                                            <div className="bg-primary inline-block p-1 px-3 text-white rounded float-right mt-2">{reservation.status}</div>
                                                        </div>
                                                    </div>
                                                </CardBody>
                                            </Card>
