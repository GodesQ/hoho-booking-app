      ...
      <Card className="p-2">
        <CardHeader className="flex flex-col items-start gap-2">
          {errors.length > 0 ? (
            errors.map((error, index) => (
              <div
                key={index}
                className="py-1.5 px-3 text-left w-full bg-primary text-white rounded"
              >
                {error}
              </div>
            ))
          ...
          <div className="flex justify-between w-full">
            ...
            <Modal isOpen={isOpen} onOpenChange={onOpenChange}>
              <ModalContent>
                {(onClose) => (
                  <>
                    <ModalHeader className="flex flex-col gap-1 text-large">
        ...
        <CardBody>
          ...
          <ButtonGroup fullWidth className="gap-3">
            <Button
              className="bg-transparent border-primary border-1 rounded text-primary"
              onClick={handleAddToCart}
            >
              Add to Cart
            </Button>
            <Button className="bg-primary text-foreground rounded">
              Book Now
            </Button>
          </ButtonGroup>
        </CardBody>
