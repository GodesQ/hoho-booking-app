                    ...
                    <div className="cart-container my-3">
                                ...
                                <div key={index + 1} className="reservation-tour-item">
                                    ...
                                    <div className="reservation-tour-main-content">
                                        <div className="reservation-tour-content">
                                            <h2 className="text-small sm:text-medium font-medium mb-1.5">{cart.tour.name}</h2>
                        ...
                        <div className="cart-form ">
                            ...
                            <button
                                ...
                                className="bg-primary hover:bg-primary-900 py-3 px-4 my-2 text-small text-white rounded w-full"
                            >
                                Checkout
                            </button>
                        </div>
                        ...
                        <Card className="px-4 py-5 max-w-[600px]">
                            <CardBody className="text-black text-center">
                                <h2 className="text-medium mb-3">
                                    <ShoppingCart color="primary" /> Your Travel Cart
                                </h2>
                                <p>There are no items in your travel cart. Click on &ldquo;Continue Shopping&ldquo; to resume your shopping.</p>
                                <Spacer y={5} />
                                <div className="text-center">
                                    <Link href="/" className="bg-primary text-white py-3 px-4 rounded max-w-[100px] text-small">
                                        Continue Shopping
                                    </Link>
                                </div>
                            </CardBody>
